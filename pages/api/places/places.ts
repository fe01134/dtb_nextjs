...
import placesJson from '../../api/data/carvoeiro.json'; // This import style requires "esModuleInterop", see "side notes"
console.log(placesJson.areas);
